...
async function checkForUpdates() {
  try {
    ...
    const VERSION_URL = {
      PROXY:
        "https://ghfast.top/raw.githubusercontent.com/yilandh/LibreTV/main/VERSION.txt",
      DIRECT:
        "https://raw.githubusercontent.com/yilandh/LibreTV/main/VERSION.txt",
    };
  ...
  checkForUpdates()
    .then((result) => {
      ...
      if (result.hasUpdate) {
        ...
        // 如果没有更新，显示当前版本为修复版本
        versionElement.innerHTML = `版本: ${result.currentFormatted} <span class="text-green-500">(修复版本)</span>`;
      }
