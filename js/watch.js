...
window.onload = function () {
  ...
  // 添加调试信息
  console.log("watch.js - backUrl:", backUrl);
  console.log("watch.js - referrer:", referrer);
  console.log("watch.js - currentParams:", currentParams.toString());
  ...
  if (backUrl) {
    ...
    console.log("watch.js - 使用back参数作为returnUrl:", returnUrl);
  } else if (
    referrer &&
    ...
    // 来源是搜索页面
    returnUrl = referrer;
    console.log("watch.js - 使用referrer作为returnUrl:", returnUrl);
    ...
    // 默认回到首页
    returnUrl = "/";
    console.log("watch.js - 使用默认首页作为returnUrl:", returnUrl);
  }
